...
public final class ConnectionPool {
	...
	private ConnectionPool() throws SQLException {
		 ...
		 */
		// db.properties 파일경로
		String filePath = "D:\\Programing\\Project\\MYproject\\myjsp\\JSPProjectPersonalHomePage\\src\\main\\java\\controller\\db.properties";
		...
		try {
			...
			e.printStackTrace();
			System.out.println("************************");
			System.out.println("IF ERROR it might be path");
			System.out.println("************************");
		}
	}
